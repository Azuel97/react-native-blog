      ...
      <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
        <TouchableOpacity onPress={this.props.onPress}>
            <View style={styles.mercatImmo}>
                ...
                <View style={{width:160, paddingTop:7}}>
                    <Text style={{color:'red',fontWeight:'bold'}}>{this.props.categoria}</Text>
                    <Text style={{fontWeight:'bold',paddingTop:3}} numberOfLines={2}>{this.props.titolo1}</Text>
        ...
        <TouchableOpacity onPress={this.props.onPress1}>
            <View style={styles.mercatImmo}>
                ...
                <View style={{width:160, paddingTop:7}}>
                    <Text style={{color:'red',fontWeight:'bold'}}>{this.props.categoria1}</Text>
        ...
        <TouchableOpacity onPress={this.props.onPress2}>
            <View style={styles.mercatImmoF}>
                <Image style={{width:160 , height: 160, backgroundColor: 'lightblue',borderRadius:3}}
                    source={{uri: `${this.props.image3}`}} />
                <View style={{width:160, paddingTop:7}}>
                    <Text style={{color:'red',fontWeight:'bold'}}>{this.props.categoria2}</Text>
