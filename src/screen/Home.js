        ...
        return (
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.ultimiArticoli}>
                ...
                <Scroll categoria={ultimiArticoli[0].category} categoria1={ultimiArticoli[1].category} categoria2={ultimiArticoli[2].category} image1={ultimiArticoli[0].image} titolo1={ultimiArticoli[0].title} abstract1={ultimiArticoli[0].abstract} image2={ultimiArticoli[1].image} titolo2={ultimiArticoli[1].title} abstract2={ultimiArticoli[1].abstract} image3={ultimiArticoli[2].image} titolo3={ultimiArticoli[2].title} abstract3={ultimiArticoli[2].abstract} onPress={ () => this.props.navigation.navigate('DetailsScreen', { categoria: ultimiArticoli[0].category,title: ultimiArticoli[0].category ,desc1: ultimiArticoli[0].abstract, image: ultimiArticoli[0].image2,  titoloBlock1: ultimiArticoli[0].TitleBlocks1,descrizioneBlock1: ultimiArticoli[0].DescriptionBlocks1, titoloBlock2: ultimiArticoli[0].TitleBlocks2,descrizioneBlock2: ultimiArticoli[0].DescriptionBlocks2 }) } onPress1={ () => this.props.navigation.navigate('DetailsScreen', { categoria: ultimiArticoli[1].category,title: ultimiArticoli[1].title ,desc1: ultimiArticoli[1].abstract, image: ultimiArticoli[1].image2,  titoloBlock1: ultimiArticoli[1].TitleBlocks1,descrizioneBlock1: ultimiArticoli[1].DescriptionBlocks1, titoloBlock2: ultimiArticoli[1].TitleBlocks2,descrizioneBlock2: ultimiArticoli[1].DescriptionBlocks2 }) } onPress2={ () => this.props.navigation.navigate('DetailsScreen', { categoria: ultimiArticoli[2].category,title: ultimiArticoli[0].title ,desc1: ultimiArticoli[0].abstract, image: ultimiArticoli[0].image2,  titoloBlock1: ultimiArticoli[0].TitleBlocks1,descrizioneBlock1: ultimiArticoli[0].DescriptionBlocks1, titoloBlock2: ultimiArticoli[0].TitleBlocks2,descrizioneBlock2: ultimiArticoli[0].DescriptionBlocks2 }) }  />
              </View>
            </ScrollView>
        );
    }
